...
<div style="margin-left:15%;padding:1px 16px;height:1000px;">
	<div style="padding-top:3%;" >
		<h3>View Subject</h3>
		<%int i=1; %>
		<a class="previous" href="CollegeDepartmentSemList.jsp">&laquo; Previous</a>
		<table border="1">
			<tr>
				<td>No</td>
				<td>Department</td>
				...
				<c:forEach items="${sessionScope.semsubjectlist }" var="q">
					<tr>
						<td><%=i %></td>
						<td>${q.departmentid.department }</td>
						<td>${q.semid.semname }</td>
						<td>${q.subject }</td>
						<td><a href="<%=request.getContextPath()%>/Exam?flag=viewcollegedepartmentsemestersubjectexam&id=${q.id }">View Exam</a></td>
