...
<div style="margin-left:25%;padding:1px 16px;height:1000px;">
	<div style="padding-top:2%;" >
		...
		<%int i=1; %>
		<a class="previous" href="CollegeSemSubjectList.jsp">&laquo; Previous</a>
		<table border="1">
			<tr>
				<td>No</td>
				...
				<c:forEach items="${sessionScope.subjectprofessorlist }" var="q">
					<tr>
						<td><%=i %></td>
						...
						<td><a href="<%=request.getContextPath()%>/Professor?flag=viewCollegeProfessorDepartmentList&id=${q.id }">View Department</a></td>
						<td><a href="<%=request.getContextPath()%>/Professor?flag=viewCollegeProfessorSemList&id=${q.id }">View Semester</a></td>
						<td><a href="<%=request.getContextPath()%>/Professor?flag=viewCollegeProfessorSubjectList&id=${q.id }">View Subject</a></td>
					</tr>
					<%i++; %>
				</c:forEach>
		</table>
