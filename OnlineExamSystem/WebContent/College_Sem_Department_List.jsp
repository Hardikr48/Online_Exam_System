...
<div style="margin-left:15%;padding:1px 16px;height:1000px;">
	<div style="padding-top:3%;" >
		...
		<c:forEach items="${sessionScope.collegedata }" var="q">
			<a class="previous" href="<%=request.getContextPath()%>/Sem?flag=viewsemlist&id=${q.id }">&laquo; Previous</a>
		</c:forEach>
		<br>
		<table border="1">
			<tr>
			...
			<c:forEach items="${sessionScope.departmentist }" var="q">
				<tr>
					...
					<td><a href="<%=request.getContextPath()%>/Subject?flag=searchcollegesubject&id=${q.id }">View Subject</a></td>
				</tr>
			</c:forEach>
		</table>
	</div>
