...
<div style="margin-left:15%;padding:1px 16px;height:1000px;">
	<div style="padding-top:3%;" >
		...
		<%int i=1; %>
		<a class="previous" href="CollegeDepartmentProfessorSemesterList.jsp">&laquo; Previous</a>
		<table border="1">
			<tr>
				<td>No</td>
				...
				<c:forEach items="${sessionScope.professordepartmentsemestersubjectlist }" var="q">
					<tr>
						<td><%=i %></td>
						<td>${q.professorid.firstName }</td>
						<td>${q.subjectid.subject }</td>
						<td><a href="<%=request.getContextPath()%>/Professor?flag=deleteprofessorsubject&id=${q.id }">Delete Subject</a></td>
					</tr>
					<%i++; %>
				</c:forEach>
		</table>
